        ...
        <nav class="hidden lg:block">
            ...
            ">
                <li class=" ml-6 block  parent">
                    <div class="">
                        <a href="{{route('home')}}" class="parent:hover:text-white transition duration-500 font-bold">Home </a>
                    </div>
                </li>
                <li class=" ml-6 block  parent">
                ...
                <li class=" ml-6 block  parent">
                    <div class="relative nav-tag">
                        <a href="{{route('single')}}" class="parent:hover:text-white transition duration-500 font-bold">Feature Movie</a>

                    </div>
                </li>
                <li class=" ml-6 block  parent">
                    <div class="relative nav-tag">
                        <a href="{{route('series')}}" class="parent:hover:text-white transition duration-500 font-bold">TV series</a>
                    </div>
                </li>
        ...
        <div class="flex justify-center h-20 items-center text-xl text-white relative">
            ...
            <div id="login" class="parent flex rounded-full  bg-black w-10 h-10">
                ...
                <div id="login-direct"
                    ...
                    <a href="{{route('register')}}" class="parent flex items-center pl-10 pr-40 justify-start py-4 text-sm under relative">
                        <i class="fa-solid fa-user-plus inline-block"></i> <span
                            class="block px-3 only-child-hover">Register</span>
                    </a>
                    <a href="{{route('login')}}" class="parent flex items-center pl-10 pr-40 justify-start py-4 text-sm">
        ...
        <div id="nav-sm" class="hidden">
            ...
            ">
                <li class=" ml-6 block parent">
                    <div class="py-2 under relative">
                        <div class="flex flex-row">
                            <a href="# " class="parent:hover:text-white transition duration-500 font-bold">Home </a>
                        </div>
                ...
                <li class=" ml-6 block parent">
                    <div class="py-2 under relative">
                        <div class="flex flex-row">
                            <a href="# " class="parent:hover:text-white transition duration-500 font-bold">The Loai </a>
                ...
                <li class=" ml-6 block parent">
                    <div class="py-2 under relative">
                        <div class="flex flex-row">
                            <a href="# " class="parent:hover:text-white transition duration-500 font-bold">Phim Bo </a>
                        </div>
                ...
                <li class=" ml-6 block parent">
                    <div class="py-2 under relative">
                        <div class="flex flex-row">
                            <a href="# " class="parent:hover:text-white transition duration-500 font-bold">TV series </a>
                        </div>
                    </div>
                </li>
