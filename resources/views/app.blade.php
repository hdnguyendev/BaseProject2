...
@section('root')
    ...
    <div
        class="h-4/5 min-h-max w-full relative text-white flex flex-col lg:flex-row  justify-between items-center bg-fixed bg-center bg-cover">
...
@section('js')
    ...
    <script>
        ...
        //     $('.btn_add_favorite').click(function(e){
        //         e.preventDefault();
        //         alert('hi');
        //     })
        // });
        ...
        //         $.ajax({
        //             type: "GET",
        //             url: "http://127.0.0.1:8000/add-favorite/" + id,
